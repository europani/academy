		...
		<table class="w3-table-all" style="width: 80%;">
			...
			<tr height="30">
				<td colspan="4" class="w3-center">
					...
					&nbsp;&nbsp;&nbsp;&nbsp; 
					<input type="button" value="답글쓰기" onclick="document.location.href='writeUploadForm?num=${article.num}&ref=${article.ref}&re_step=${article.re_step}&re_level=${article.re_level}'">
					&nbsp;&nbsp;&nbsp;&nbsp; 
