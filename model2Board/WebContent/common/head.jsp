...
<body>
	<div class="w3-bar w3-large"
		...
		<a href="<%=request.getContextPath()%>/list.do?boardid=1" class="w3-bar-item w3-button">공지사항</a> 
		<a href="<%=request.getContextPath()%>/list.do?boardid=2" class="w3-bar-item w3-button">자유게시판</a> 
		...
		<c:if test="${idKey == null}">
			<a href="<%=request.getContextPath()%>/member/member.do" class="w3-bar-item w3-button">회원가입</a> 
			<a href="<%=request.getContextPath()%>/member/login.do" class="w3-bar-item w3-button">로그인</a>
		</c:if>	
		<c:if test="${idKey != null}">
			<a href="<%=request.getContextPath()%>/member/update.do" class="w3-bar-item w3-button">회원수정</a> 
			<a href="<%=request.getContextPath()%>/member/logout.do" class="w3-bar-item w3-button">로그아웃</a>
		</c:if>	
	</div>