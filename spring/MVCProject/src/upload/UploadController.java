...
public class UploadController {
	...
	public String uploadMultipartFile(@RequestParam("f") MultipartFile multipartFile, @RequestParam("title") String title,
	...
	public String uploadBycommandObject(FileCommand command, Model model) throws IOException {
