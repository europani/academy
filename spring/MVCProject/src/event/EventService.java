...
public class EventService {
	...
	public EventService() {
		...
		eventMap.put(1L, Event.create(2L, "Okjsp 생존 테스트 프로그래밍", EventType.CONFERENCE));
		eventMap.put(1L, Event.create(3L, "강남 스타일 플래시몹", EventType.FLASHMOB));
		eventMap.put(1L, Event.create(4L, "태극 플래시몹", EventType.FLASHMOB));
		eventMap.put(1L, Event.create(5L, "플랫폼 데이", EventType.CONFERENCE));
		eventMap.put(1L, Event.create(6L, "동춘 서커스", EventType.CIRCUS));
	}
